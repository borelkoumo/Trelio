...
export default function DisplayQRPage() {
  ...
  // Countdown tick — independent of QR interval
  useEffect(() => {
  ...
  // Countdown display: circular-ish progress, color shifts red below 10s
      ...
      <div className="lg:pl-64 flex flex-col min-h-screen">
        ...
        <main className="flex-1 pt-14 lg:pt-0">
          ...
          <div className="lg:hidden px-5 pt-8 pb-16 max-w-md mx-auto flex flex-col gap-10">
            ...
            {/* Demandes section (manual mode only) */}
          ...
          <div className="hidden lg:flex gap-6 p-6 h-[calc(100vh-4rem)] max-w-[1440px] mx-auto w-full">
            ...
            {/* Left panel: Scanner QR */}
            <div className={`flex flex-col rounded-2xl border border-[#69f6b8]/10 overflow-hidden ${merchant?.validation_mode === 'manual' ? 'w-[45%]' : 'flex-1'}`}
            ...
            {/* Divider + Right panel: only in manual mode */}
            {merchant?.validation_mode === 'manual' && (
              <>
